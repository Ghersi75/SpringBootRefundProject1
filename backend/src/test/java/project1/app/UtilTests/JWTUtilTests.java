...
public class JWTUtilTests {
  ...
  public void testExtractFromInvalidJWT() {
    ...
    assertThrows(InvalidJWTException.class, () -> JWTUtil.extractUserInfoFromJWT(modifiedHeader));
    ...
    assertThrows(InvalidJWTException.class, () -> JWTUtil.extractUserInfoFromJWT(modifiedPayload));

    String modifierSignature = userId1RoleManagerJWT.substring(0, userId1RoleManagerJWT.length() - 3);
    assertThrows(InvalidJWTException.class, () -> JWTUtil.extractUserInfoFromJWT(modifierSignature));
  }
  ...
  public void testExtractFromValidJWTInvalidPayload() {
    ...
    assertThrows(InvalidJWTPayloadException.class, () -> JWTUtil.extractUserInfoFromJWT(userIdJWT));
    ...
    assertThrows(InvalidJWTPayloadException.class, () -> JWTUtil.extractUserInfoFromJWT(emptyPayloadJWT));
  }
}
