...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
  ...
  @Query("SELECT t FROM Ticket t WHERE (:userId IS NULL OR :userId = t.user.id) AND (:ticketStatus IS NULL OR :ticketStatus = t.ticketStatus) ORDER BY t.timeAdded ASC")
